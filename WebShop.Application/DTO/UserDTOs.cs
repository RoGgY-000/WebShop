...
namespace WebShop.Application.DTO
{
    ...
    public record AddRoleToUserRequest (Guid RoleId) : IRequest;
    public record UserResponse (Guid Id, string FirstName, string LastName, string Email, string PhoneNumber, List<Role> Roles, List<Order> Orders);
}
